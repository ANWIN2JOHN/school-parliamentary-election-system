...
export function ResultsView() {
  ...
  // Prevent crash while Supabase data is loading
  if (chairs.length === 0 || leaders.length === 0) {
    return (<div className="p-6"> <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100"> <h2 className="text-xl font-bold text-slate-900">
      Loading election results... </h2> <p className="text-slate-500 mt-2">
        Fetching candidates and votes from Supabase. </p> </div> </div>
    );
  }
